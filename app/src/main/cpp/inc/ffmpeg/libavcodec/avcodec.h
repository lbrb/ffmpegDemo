 ...
 *
 * AVPacket is one of the few structs in PlayControl, whose size is a part of public
...
#define AV_EF_AGGRESSIVE (1<<18)        ///< consider things that a sane encoder should not do as an error
     ...
     * data PlayControl cannot instantiate itself. Please refer to the
     * PlayControl HW accelerator documentation to know how to fill this
 ...
 * intended to be used internally by PlayControl (libavcodec, libavformat, etc.)
